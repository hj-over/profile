...
const Join = () => {
  ...
  const check = (_val) => {
    ...
    // 주소 입력 체크
    if (_val.address === "") {
      errs.address = "주소를 입력해 주세요.";
    }
    // 상세주소 입력 체크
    if (_val.address2 === "") {
      errs.address2 = "상세주소를 입력해 주세요.";
    }
    // 생년월일 체크
    if (_val.birthday === "") {
    ...
    if (_val.comment.length < 20) {
      errs.comment = "추가 사항은 20자 이상 입력해 주세요.";
    }
    return errs;
  };
        ...
        <fieldset>
          ...
          <table>
            ...
            <tbody>
              ...
              {/* 주소 입력 : https://www.npmjs.com/package/react-daum-postcode*/}
              <tr>
                <th>
                  {" "}
              ...
              <tr>
                ...
                <td>
                  {/* 단순한 글자입력만 가능. WySIWYG EDITOR가 필요 */}
                  <textarea
                    name="comment"
                    id="comment"
                    cols="30"
